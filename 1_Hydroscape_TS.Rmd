...
ggsave('figures/cumForestLoss_wRiv.png', g, height = 8, width = 5, units = 'in')
...
sites.sf <- read.csv("in/Oxbow.lake.data.csv") %>%
  ...
  filter(!(Site.number == 9 & Site.type == 'river.downstream')) %>% #data entry error.
...
ggsave('figures/SampleSites.png', width = 4, height = 4, units ='in')
