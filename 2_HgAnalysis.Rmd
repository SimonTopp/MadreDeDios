...
g5 <- ggplot(water.all,aes(x=Site.type, y=TSS.mg.L, fill=Site.type))+
  geom_boxplot()+
  theme_bw()+
  theme(axis.text.x = element_text(angle = 20, hjust = 1)) +
  labs(x="", y="TSS (mg/L)") +
...
ggsave('figures/HgAnalysis.png', plot = g, width = 7, units = 'in')

#Sediment figure
ggpubr::ggarrange(g4,gg4,nrow=1,ncol=2,common.legend=TRUE)
ggsave('figures/HgSed.png', width = 7, height = 3.5, units = 'in')

##TSS Figure
ggpubr::ggarrange(g5,gg5,nrow=1,ncol=2,common.legend=TRUE)
ggsave('figures/HgTSS.png', width = 7, height = 3.5, units = 'in')
...
ggsave('figures/TSSvTHg.png', width = 5, height = 3, units = 'in')
