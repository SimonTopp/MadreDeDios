...
ggsave('figures/Final/TSSvTHgvMeHgLog.png', plot = g, width = 7, height = 3, units = 'in', dpi = 600)
...
tukeyMeHg <- tibble(Site.type = c('River Upstream', 'Oxbow Upstream', 'Mining Pond', 'River Downstream', 'Oxbow Downstream'), TukeyStats = c('a','a','a','ab','a'))
